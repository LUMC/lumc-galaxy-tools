...
class DataTable(object):
    ...
    def __init__(self,
        ...
        self.name = name if name else self.index_path.with_suffix('').name.__str__()
    ...
    def check_index_file_presence(self):
        ...
        if not index_name:
            raise ValueError(
                "Property 'name' not defined for '{0}', please contact the developers to correct the mistake.")
